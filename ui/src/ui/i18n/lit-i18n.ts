...
export const msg = (key: string, params?: Record<string, any>) => {
...
export class LocalizedContent extends HTMLElement {
  ...
  connectedCallback() {
    ...
    window.addEventListener('localeChanged', this.render.bind(this));
  }

  disconnectedCallback() {
    window.removeEventListener('localeChanged', this.render.bind(this));
  }
